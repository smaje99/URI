...
*/
func testLeftArea(t *testing.T, input, expected string) {
	...
	// Call the LeftArea function (main function)
	LeftArea()
...
`,
	...
	for _, test := range tests {
		testLeftArea(t, test.input, test.expected)
	}
}
