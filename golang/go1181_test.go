...
*/
func testLineInArray(t *testing.T, input, expected string) {
	...
	// Call the LineInArray function (main function)
	LineInArray()
...
*/
func TestLineInArray(t *testing.T) {
	// Define test cases
	tests := []struct {
		input    string
		expected string
...
`,
	...
	for _, test := range tests {
		testLineInArray(t, test.input, test.expected)
	}
}
