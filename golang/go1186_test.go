...
*/
func testBelowTheSecondaryDiagonal(t *testing.T, input, expected string) {
	...
	// Call the BelowTheSecondaryDiagonal function (main function)
	BelowTheSecondaryDiagonal()
...
*/
func TestBelowTheSecondaryDiagonal(t *testing.T) {
	// Define test cases
	tests := []struct {
		input    string
		expected string
...
`,
	...
	for _, test := range tests {
		testBelowTheSecondaryDiagonal(t, test.input, test.expected)
	}
}
