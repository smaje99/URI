...
*/
func testBelowTheMainDiagonal(t *testing.T, input, expected string) {
	...
	// Call the BelowTheMainDiagonal function (main function)
...
*/
func TestBelowTheMainDiagonal(t *testing.T) {
	// Define test cases
	tests := []struct {
		input    string
		expected string
...
`,
	...
	for _, test := range tests {
		testBelowTheMainDiagonal(t, test.input, test.expected)
	}
}
